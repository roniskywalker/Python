...
print(myDict.get("Ankan")) # Prints value associated with key "harry"
print(myDict["Ankan"]) # Prints value associated with key "harry"

# The difference between .get and [] sytax in Dictionaries?
print(myDict.get("Ankan2")) # Returns None as harry2 is not present in the dictionary
